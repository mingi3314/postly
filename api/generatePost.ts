...
- 아래에 제공할 레퍼런스 자료들을 취합하여 글을 작성해주세요.
- 기존에 업로드된 게시글의 스타일과 톤을 통일성 있게 유지해야 합니다. <Examples> 태그에 있는 예시 데이터 목록을 참고해주세요. 
- 전체 글은 4-5개의 문장으로 구성해주세요.
- 글의 주요 단어를 활용하여 해시태그를 만들어주세요. 순서는 #eyesmag #영어1 #영어2 ... #한글1 #한글2 입니다.
- 권유문(예: 초대합니다, 경험하세요 등)은 사용하지 마세요. 단, 마지막 문장에서 추가 정보 확인을 요청하는 경우는 예외입니다.
- 느낌표를 사용하지 마세요.
